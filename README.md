...
- Used `<figure>` and `<figcaption>` for content images
- Updated all external links to open in a new tab (`target="_blank"`)
- Removed redundant `role` attributes where not necessary
...
- HTML5
- CSS3
- Accessibility (WAI-ARIA concepts)
- Semantic HTML
- GitLab Pages
